...
export const VEXA_DIAGNOSTIC_CODES = {
  ...
  DUPLICATE_CLASS_VARIABLE: "MYL2028",
  VARIABLE_USED_BEFORE_INITIALIZATION: "MYL2029",
  CLASS_FIELD_NOT_INITIALIZED: "MYL2030",
  ...
  STYLE_UNUSED_IMPORT: "MYL3002",
  STYLE_DEPRECATED_MEMBER: "MYL3003"
} as const;
...
export function mapAnalysisIssueCodeToDiagnosticCode(
  ...
  switch (issueCode) {
    ...
    case ANALYSIS_ISSUE_CODES.MISSING_PARAMETER_TYPE:
      return VEXA_DIAGNOSTIC_CODES.MISSING_PARAMETER_TYPE;
    case ANALYSIS_ISSUE_CODES.DUPLICATE_CLASS_VARIABLE:
      return VEXA_DIAGNOSTIC_CODES.DUPLICATE_CLASS_VARIABLE;
    case ANALYSIS_ISSUE_CODES.CLASS_FIELD_NOT_INITIALIZED:
      return VEXA_DIAGNOSTIC_CODES.CLASS_FIELD_NOT_INITIALIZED;
    case ANALYSIS_ISSUE_CODES.VARIABLE_USED_BEFORE_INITIALIZATION:
      return VEXA_DIAGNOSTIC_CODES.VARIABLE_USED_BEFORE_INITIALIZATION;
    default:
      return null;
  }
}
