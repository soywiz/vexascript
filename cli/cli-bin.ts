...
const CLI_HELP_TEXT = [
  ...
  "",
  "Commands:",
  "  build <input>     Compile a VexaScript file to JavaScript",
  "  cpp <input>       Compile, link, or run through the native C++ backend",
  "    build <input>   Compile to a C++ translation unit",
  "    link <input>    Compile and link a cached native executable",
  "    run <input>     Compile, link, and run a cached native executable",
