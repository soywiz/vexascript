...
- CLI (`cli/`):
  ...
  - CLI entrypoint and command implementation, including single-file JavaScript transpilation and directory-based static site builds that materialize the `serve` bundle and mapped assets into `dist`/`outDir`: `cli/cli.ts`
