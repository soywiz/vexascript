...
- Native C++ support:
  - Cached Oilpan runtime, including the generated-code interface and template definitions in `native/runtime.hpp`, the separately compiled static-library entrypoint in `native/runtime.cpp`, reference-semantic traced `ArrayObject<T>` storage, a native `performance.now()` steady clock, a dependency-free arbitrary-precision integer implementation, UTF-16/UTF-8 operating-system boundary adapters, and the vendored standalone Oilpan (forked 20260622) and trimmed mimalloc source archives used by generated C++ builds: `native/runtime.hpp`, `native/runtime.cpp`, `native/bigint.h`, `native/utf.h`, `native/oilpan-20260622.zip`, `native/mimalloc-3.4.3.zip`
