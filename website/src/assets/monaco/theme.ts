...
export function createVexaScriptMonacoTheme(): MonacoStandaloneThemeData {
  return {
    ...
    rules: [
      ...
      { token: "keywordType", foreground: "569CD6" },
      ...
      { token: "regexpCharacterClass", foreground: "4EC9B0" },
      { token: "regexpSpecial", foreground: "C586C0" },
      { token: "regexpFlag", foreground: "569CD6" },
      { token: "operator", foreground: "C4D0FF" },
