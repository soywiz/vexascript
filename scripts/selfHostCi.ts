import { appendFile, copyFile, cp, mkdir, mkdtemp, readFile, readdir, rm, symlink } from "node:fs/promises";
...
async function main(): Promise<void> {
  ...
  try {
    ...
    try {
      ...
      await cp(resolve(rootDirectory, "native", "runtime"), resolve(tscDirectory, "native", "runtime"), { recursive: true });
