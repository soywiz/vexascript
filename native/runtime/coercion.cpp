...
double Number(double value) { return value; }

double Number(bool value) { return value ? 1 : 0; }

double Number(int value) { return static_cast<double>(value); }

double Number(std::int64_t value) { return static_cast<double>(value); }

double Number(const BigInt& value) { return value.toDouble(); }
...
bool Boolean(Undefined) { return false; }

bool Boolean(double value) { return value != 0 && !std::isnan(value); }

bool Boolean(const std::u16string& value) { return !value.empty(); }
