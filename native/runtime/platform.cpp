...
void* LibraryOpen::open(std::initializer_list<std::string_view> paths) {
...
void* LibraryOpen::symbol(std::initializer_list<std::string_view> paths, std::string_view name) {
...
cppgc::PageAllocator* OilpanPlatform::GetPageAllocator() { return &allocator_; }

double OilpanPlatform::MonotonicallyIncreasingTime() {
...
std::u16string vexaRuntimeName() { return u"native"; }
