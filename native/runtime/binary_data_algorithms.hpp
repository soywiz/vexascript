...
double atomicsNotify(Int32ArrayObject*, double, double = std::numeric_limits<double>::infinity());
std::u16string atomicsWait(Int32ArrayObject* array, double index, double value, double = std::numeric_limits<double>::infinity());
RecordObject* atomicsWaitAsync(Int32ArrayObject* array, double index, double value, double timeout = std::numeric_limits<double>::infinity());
