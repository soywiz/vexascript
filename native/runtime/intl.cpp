...
std::u16string DurationFormatObject::format(RecordObject* duration) const {
...
ArrayObject<RecordObject*>* DurationFormatObject::formatToParts(RecordObject* duration) const {
...
RecordObject* DurationFormatObject::resolvedOptions() const {
...
const void* DurationFormatObject::dynamicTypeToken() const { return nativeTypeToken<DurationFormatObject>(); }

void* DurationFormatObject::dynamicCast(const void* type) {
    return type == nativeTypeToken<DurationFormatObject>() ? this : nullptr;
  }

std::u16string DurationFormatObject::dynamicToString() const { return u"[object Intl.DurationFormat]"; }

void DurationFormatObject::Trace(cppgc::Visitor* visitor) const { BaseObject::Trace(visitor); }
...
Value IntlSegmentsObject::containing(double codeUnitIndex) const {
...
ArrayObject<RecordObject*>* IntlSegmentsObject::items() const { return items_.Get(); }

bool IntlSegmentsObject::dynamicIsIterable() const { return true; }

std::size_t IntlSegmentsObject::dynamicIterableSize() const { return items_->size(); }

Value IntlSegmentsObject::dynamicIterableGet(std::size_t index) {
    return index < items_->size() ? Value(items_->get(index)) : Value::undefined();
  }

const void* IntlSegmentsObject::dynamicTypeToken() const { return nativeTypeToken<IntlSegmentsObject>(); }

void* IntlSegmentsObject::dynamicCast(const void* type) {
...
std::u16string IntlSegmentsObject::dynamicToString() const { return u"[object Intl.Segments]"; }

void IntlSegmentsObject::Trace(cppgc::Visitor* visitor) const {
...
int IntlObject::compare(const std::u16string& left, const std::u16string& right) const {
...
std::u16string IntlObject::format(double value) const {
...
std::u16string IntlObject::format(const BigInt& value) const { return value.toString(); }

std::u16string IntlObject::format(double value, const std::u16string& unit) const {
...
std::u16string IntlObject::formatRange(double start, double end) const {
    return format(start) + u" – " + format(end);
  }

ArrayObject<RecordObject*>* IntlObject::formatToParts(double value) const {
    return singlePart(kind_ == IntlObjectKind::NumberFormat ? u"integer" : u"literal", format(value));
  }

ArrayObject<RecordObject*>* IntlObject::formatToParts(double value, const std::u16string& unit) const {
    auto* result = makeManaged<ArrayObject<RecordObject*>>();
...
ArrayObject<RecordObject*>* IntlObject::formatRangeToParts(double start, double end) const {
...
std::u16string IntlObject::select(double value) const {
...
std::u16string IntlObject::selectRange(double start, double end) const {
    return start == end ? select(start) : u"other";
  }

Value IntlObject::of(const std::u16string& code) const {
...
RecordObject* IntlObject::resolvedOptions() const {
    auto* result = makeManaged<RecordObject>();
    result->set(u"locale", Value(makeManaged<StringObject>(locale_)));
    result->set(u"numberingSystem", Value(makeManaged<StringObject>(u"latn")));
    switch (kind_) {
...
IntlSegmentsObject* IntlObject::segment(const std::u16string& input) const {
    return makeManaged<IntlSegmentsObject>(input, optionText(u"granularity", u"grapheme"));
  }

IntlObject* IntlObject::maximize() const {
...
IntlObject* IntlObject::minimize() const {
    std::u16string result = locale_;
...
const std::u16string& IntlObject::toString() const { return locale_; }

const std::u16string& IntlObject::baseName() const { return base_name_; }

const std::u16string& IntlObject::language() const { return language_; }

Value IntlObject::script() const { return script_.empty() ? Value::undefined() : Value(makeManaged<StringObject>(script_)); }

Value IntlObject::region() const { return region_.empty() ? Value::undefined() : Value(makeManaged<StringObject>(region_)); }

Value IntlObject::calendar() const { return optionValue(u"calendar"); }

Value IntlObject::caseFirst() const { return optionValue(u"caseFirst"); }

Value IntlObject::collation() const { return optionValue(u"collation"); }

Value IntlObject::hourCycle() const { return optionValue(u"hourCycle"); }

Value IntlObject::numberingSystem() const { return optionValue(u"numberingSystem"); }

bool IntlObject::numeric() const { return optionBoolean(u"numeric", false); }

const void* IntlObject::dynamicTypeToken() const { return nativeTypeToken<IntlObject>(); }

void* IntlObject::dynamicCast(const void* type) {
    if (type == nativeTypeToken<IntlObject>()) return this;
    return type == nativeTypeToken<BaseObject>() ? static_cast<BaseObject*>(this) : nullptr;
  }

std::u16string IntlObject::dynamicToString() const {
    return kind_ == IntlObjectKind::Locale ? locale_ : u"[object Intl]";
  }

void IntlObject::Trace(cppgc::Visitor* visitor) const {
    BaseObject::Trace(visitor);
    visitor->Trace(options_);
  }

Value IntlObject::optionValue(const std::u16string& key) const {
    return options_ ? options_->get(key) : Value::undefined();
  }

std::u16string IntlObject::optionText(const std::u16string& key, std::u16string fallback) const {
    const Value value = optionValue(key);
    return value.isString() ? value.utf16() : fallback;
  }

bool IntlObject::optionBoolean(const std::u16string& key, bool fallback) const {
    const Value value = optionValue(key);
    return value.isUndefined() ? fallback : static_cast<bool>(value);
  }

std::u16string IntlObject::formatNumber(double value) const {
...
std::u16string IntlObject::formatDate(double milliseconds) const {
...
ArrayObject<RecordObject*>* IntlObject::singlePart(const std::u16string& type, const std::u16string& value) const {
    auto* result = makeManaged<ArrayObject<RecordObject*>>();
    auto* part = makeManaged<RecordObject>();
...
DurationFormatObject::DurationFormatObject(std::u16string locale, RecordObject* options)
...
IntlSegmentsObject::IntlSegmentsObject(std::u16string input, std::u16string granularity)
...
IntlObject::IntlObject(IntlObjectKind kind, Value locales, Value options)
