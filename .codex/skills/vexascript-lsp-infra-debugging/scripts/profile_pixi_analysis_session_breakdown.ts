...
async function main(): Promise<void> {
  ...
  process.stdout.write(`externalDeclarations: ${collected.externalDeclarations.length}\n`);
  process.stdout.write(`importedSymbolTypes: ${collected.importedSymbolTypes.size}\n`);
